...
class viewFrame(QMainWindow):
    ...
    def loadImage(self, qt_img: QPixmap, timestamp, results, sauce):
        self.sauce = sauce
        ...
        if len(results[0][0]["boxes"].tolist()) == 0:
            self.cameraLabel.setPixmap(QPixmap.fromImage(qt_img))
        ...
        for result in results[0]:
            ...
            for box, cls, conf in zip(boxes, classes, confs):
                ...
                self.objectConf.setFixedWidth(300)
